<section>
    <x-marketing.elements.heading
        level="h2"
        title="Choisissez le forfait qui vous convient le mieux"
        description="Mettez les voiles et découvrez les richesses de nos plans à prix avantageux, méticuleusement conçus pour vous offrir les meilleures fonctionnalités à moindre coût lors de votre expédition SaaS." 
    />
    ...
    <p class="w-full mt-0 mb-8 text-center text-zinc-500 sm:my-10"></p>
</section>