    ...
    <div :class="{ '-translate-x-full': !sidebarOpen }"
        ...
        <div class="flex flex-col justify-between w-full overflow-auto md:h-full h-svh pt-4 pb-2.5">
            <div class="relative flex flex-col">
                ...
                <x-app.sidebar-dropdown text="Créer une annonce" icon="phosphor-megaphone" id="projects_dropdown" 
                    :active="Request::is('annonces*')" :open="Request::is('annonces*') ? '1' : '0'">
                    
                    <x-app.sidebar-link href="{{ route('wave.dashboard.announcements.create') }}" icon="phosphor-plus" 
                        :active="Request::is('wave/dashboard/announcements/create')">
                        Ajouter une annonce
                    </x-app.sidebar-link>

                    <x-app.sidebar-link href="" icon="phosphor-cube" 
                        :active="Request::is('wave/dashboard/announcements')">
                        Voir mes annonces
                    </x-app.sidebar-link>

                </x-app.sidebar-dropdown>

                <x-app.sidebar-link href="{{ route('wave.dashboard.announcements.create') }}" icon="phosphor-bell" 
                        :active="Request::is('wave/dashboard/announcements/create')">
                        Notification
                </x-app.sidebar-link>

                <x-app.sidebar-link href="{{ route('wave.dashboard.announcements.create') }}" icon="phosphor-package" 
                        :active="Request::is('wave/dashboard/announcements/create')">
                        Forfaits
                </x-app.sidebar-link>

                <x-app.sidebar-link href="{{ route('wave.dashboard.announcements.create') }}" icon="phosphor-bookmarks" 
                        :active="Request::is('wave/dashboard/announcements/create')">
                        Favoris et Abonnements
                </x-app.sidebar-link>

                <x-app.sidebar-link href="{{ route('wave.dashboard.announcements.create') }}" icon="phosphor-shopping-cart" 
                        :active="Request::is('wave/dashboard/announcements/create')">
                        Commandes
                </x-app.sidebar-link>

                <x-app.sidebar-link href="{{ route('wave.dashboard.announcements.create') }}" icon="phosphor-download" 
                        :active="Request::is('wave/dashboard/announcements/create')">
                        Telechargements
                </x-app.sidebar-link>
